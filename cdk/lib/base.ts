      ...
      init: ec2.CloudFormationInit.fromConfigSets({
        ...
        configs: {
          ...
          userspace: new ec2.InitConfig([
            ec2.InitFile.fromUrl(
              "C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\parsec.zip",
              "https://github.com/ajvpot/Parsec-Cloud-Preparation-Tool/archive/master.zip",
            ),
            ...
            ec2.InitFile.fromUrl(
              "C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\cuda.exe",
              this.props.cudaUrl,
            ),
            ec2.InitFile.fromUrl(
              "C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\python.exe",
              this.props.pythonUrl,
            ),
            ec2.InitFile.fromUrl(
              "C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\td.exe",
              this.props.tdUrl,
            ),
            ec2.InitFile.fromUrl(
              "C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\NDI Tools 6.exe",
              "https://downloads.ndi.tv/Tools/NDI%206%20Tools.exe",
            ),

            ec2.InitCommand.shellCommand(
              `powershell.exe -Command "Start-Process -FilePath 'C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\cuda.exe' -ArgumentList '-s' -Wait -NoNewWindow"`,
              {
                key: "91-user-cuda",
                waitAfterCompletion: ec2.InitCommandWaitDuration.of(
                  cdk.Duration.seconds(0),
            ...
            ec2.InitCommand.shellCommand(
              `"C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\python.exe" /quiet InstallAllUsers=1 PrependPath=1 Include_test=0"`,
              {
                key: "92-user-python",
                waitAfterCompletion: ec2.InitCommandWaitDuration.of(
                  cdk.Duration.seconds(0),
            ...
            ec2.InitCommand.shellCommand(
              `"C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\td.exe" /VERYSILENT /Codemeter"`,
              {
                key: "93-user-td",
                waitAfterCompletion: ec2.InitCommandWaitDuration.of(
                  cdk.Duration.seconds(0),
            ...
            ec2.InitCommand.shellCommand(
              `powershell.exe -Command "Rename-Computer -NewName CLOUD-TD"`,
              {
                key: "94-user-rename",
                waitAfterCompletion: ec2.InitCommandWaitDuration.of(
                  cdk.Duration.seconds(0),
            ...
            ec2.InitCommand.shellCommand(
              `"C:\\Users\\Administrator\\Desktop\\InstallationFiles\\9_user\\NDI Tools 6.exe" /VERYSILENT "/LOADINF=ndiconfig"`,
              {
                key: "90-user-ndi",
                waitAfterCompletion: ec2.InitCommandWaitDuration.of(
                  cdk.Duration.seconds(0),
